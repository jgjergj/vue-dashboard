...
export class AccountsClient {
    ...
    getAll(filterBy?: string | null | undefined, value?: string | null | undefined): Promise<AccountVM[]> {
...
export class LeaguesClient {
    ...
    getAll(filterBy?: string | null | undefined, value?: string | null | undefined): Promise<LeagueVM[]> {
...
export class SportsClient {
    ...
    getAll(filterBy?: string | null | undefined, value?: string | null | undefined): Promise<SportVM[]> {
    ...
    getByState(stateId: number): Promise<SportVM[]> {
        let url_ = this.baseUrl + "/api/Sports/GetByState/{stateId}";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetByState(_response);
        });
    }

    protected processGetByState(response: Response): Promise<SportVM[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class TeamsClient {
    ...
    getAll(filterBy?: string | null | undefined, value?: string | null | undefined): Promise<TeamVM[]> {
